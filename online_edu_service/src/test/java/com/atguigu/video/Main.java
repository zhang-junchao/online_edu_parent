...
public class Main {
    //账号AccessKey信息请填写(必选)
    private static String access_key_id = "LTAI4FxsK9JSReknyhkHTKSV";
    //账号AccessKey信息请填写(必选)
    private static String access_key_secret = "CVKyxxf57WPy49XSxOeCum2B4DiCyd";
    ...
    private static Map<String, String> generatePrivateParamters() {
        ...
        // 视频ID
        privateParams.put("VideoId", "7cc19f9fba0c4b62bed9026134827ea9");
        // API名称
